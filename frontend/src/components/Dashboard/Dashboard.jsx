...
const MeetingCard = ({ meeting, onJoin, currentUserId }) => {
...
export default function Dashboard() {
  ...
  const filteredMeetings = meetings.filter(m => {
    if (tab === 'hosted') return String(m.host?._id || m.host) === String(user?._id);
  ...
  const SidebarContent = () => (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ borderTop: '1px solid var(--border)', padding: '12px 8px' }}>
        ...
        <button
          className="sidebar-nav-item"
          style={{ border: 'none', width: '100%', textAlign: 'left', color: 'var(--danger)' }}
      ...
      {isMobile && sidebarOpen && (
        <>
          ...
          <div style={{
            ...
            overflow: 'auto', animation: 'slideRight 0.25s ease-out',
          }}>
            <SidebarContent />
          </div>
        </>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ display: 'flex', gap: 6 }}>
                    <input
                      className="input"
                      style={{ fontSize: '0.8rem', padding: '6px 10px', flex: 1, minWidth: 0 }}
